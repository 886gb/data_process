...
def compare_data_files(raw_file_path, dup_file_path, output_dir=None, print_diff=True):
    ...
    """
    # 获取数据统计
    raw_counts, raw_total = data_summary(raw_file_path)
    dup_counts, dup_total = data_summary(dup_file_path)
...
if __name__ == '__main__':
    # 示例用法
    raw_file_path = "data/test_preference_all.json"
    dup_file_path = "outputs/test/test_preference_all/all_dedup_eps0.3/all_files_dedup_eps0.3.jsonl"
